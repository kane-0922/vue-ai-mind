    ...
    <div class="sidebar">
      ...
      <div class="ai-assistant-info">
        <div class="breathing-circle">
          <el-image :src="iconRobot" alt="AI助手图标" style="width: 25px; height: 25px"></el-image>
        </div>
        <h3 class="assistant-name">HI,我是小暖</h3>
      ...
      <div class="chat-header">
        <div class="header-left">
          <div class="chat-avatar">
            <el-image :src="iconLike" alt="爱心" style="width: 30px; height: 30px"></el-image>
          </div>
          <div class="chat-info">
            <h2>心理健康AI助手</h2>
            <p>小暖是一个智能助手，你可以和它进行对话。</p>
          </div>
        </div>
        ...
        <div class="message-item ai-message" v-if="messages.length === 0">
          ...
          <div class="message-content">
            <div class="message-bubble">
              <p>
                您好，我是小暖，您的AI心理健康助手。很高兴陪伴您，为您提供温暖的心理支持。
                请告诉我，今天您感觉怎么样？有什么想要分享吗？
              </p>
            </div>
